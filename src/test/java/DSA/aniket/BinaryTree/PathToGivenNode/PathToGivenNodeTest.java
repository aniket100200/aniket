...
class UsingIterativeDFSTest {
    ...
    private TreeNode sortedArrayToBST(Integer[] arr) {
    ...
    void testExample1() {
        ...
        TreeNode root = sortedArrayToBST(new Integer[]{1, 2, 3, 4, 5, 6, 7});
    ...
    void testExample2() {
        ...
        TreeNode root = sortedArrayToBST(new Integer[]{1, 2, 3, 4, 5});
    ...
    void testLeftmostDeepNode() {
        ...
        TreeNode root = sortedArrayToBST(new Integer[]{1, 2, null, 3, null, 4});
    ...
    void testNodeNotFound() {
        ...
        TreeNode root = sortedArrayToBST(new Integer[]{1, 2, 3});
